            ...
            ->columns([
                ...
                Tables\Columns\ImageColumn::make('image')
                    ->getStateUsing(function (Category $record): string {
                        ...
                        return 'https://wemarketglobal.com/cms/public/category/' . $path;
                    })
                    ->action(
                        Tables\Actions\Action::make('view')
                            ...
                            ->modalContent(
                                ...
                                new HtmlString('<img src="https://wemarketglobal.com/cms/public/category/' . str_replace('\\', '/', $record->image) . '" class="w-full">')
                            )
                    ),
